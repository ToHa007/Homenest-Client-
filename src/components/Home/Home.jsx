...
// FIXED: Changed from /latest-properties to /all-properties to match your server routes
// This prevents the "Unexpected token <" error caused by 404 HTML responses.
const latestPropertiesPromise = fetch('https://homenest-server-ruby.vercel.app/all-properties')
  .then(res => {
    if (!res.ok) {
    ...
    <div>
      ...
      <div className="carousel w-full h-[70vh]">
        ...
        <div id="slide4" className="carousel-item relative w-full">
          <img
            src="https://images.unsplash.com/photo-1439130490301-25e322d88054?auto=format&fit=crop&w=1200&q=80"
            className="w-full object-cover"
            alt="Property 4"
          />
          <div className="absolute flex justify-between -translate-y-1/2 left-5 right-5 top-1/2">
      ...
      <div>
        <LatestProperties latestPropertiesPromise={latestPropertiesPromise} />
      </div>
